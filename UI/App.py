...
try:
    ...
    st.markdown(":grey[Welcome to our laptop search engine! We make finding your perfect match easy. Our algorithm considers RAM, storage, screen size, and price to pinpoint optimal options.] :orange[Worried about compromising? Don't be – we optimize matches to meet all your preferences]. :grey[Need something specific? Easily filter your results. Start exploring now!]")
