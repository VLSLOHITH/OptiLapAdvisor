...
## App:https://optilapadvisor-swrcy7emd9z5nqhtoutems.streamlit.app/
...
<h3 color="blue">From the above graphs one can observe that there are more number of "8 GB" RAM ,"512 GB" Storage,"15.6" inches screen size, "Non Gaming","No Finger Print Featured", "No OLED Featured", "SSD Featured","New",around "4 points" Rated,around "50,000 Rs" priced Laptops.<h3>
